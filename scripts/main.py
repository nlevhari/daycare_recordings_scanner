...
from analyze_tone import analyze_audio_tone
...
def is_segment_problematic(seg_analysis: Dict, tone_analysis: Dict) -> bool:
    ...
    # 2) Check Hebrew toxicity label & score
    if (seg_analysis["hebrew_analysis"]["toxicity_label"] == "toxic" and
        seg_analysis["hebrew_analysis"]["toxicity_score"] > 0.5):
        return True
...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        _ = preprocess_audio(input_file, processed_path)
